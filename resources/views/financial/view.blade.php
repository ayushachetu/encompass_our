			...
			<div class="col-md-12">
				...
				<div class="panel panel-piluku">
					<div class="panel-body">
						...
						<a href="/financial" class="btn btn-green"><i class="ti-angle-left"></i> List</a>
						<a href="/financial-export/{{$id}}" class="btn btn-green pull-right"> Download</a>
						<?php 
						//echo $contents;
									...
									<tbody>
										@foreach ($financials as $financial)
											<tr class="table-row">
												...
												<td>{{ date( 'm/d/Y', strtotime( $financial->invoice_date) ) }}</td>
												<td class="text-right">{{ $financial->invoice_amount }}</td>
												<td>{{ $financial->account_number }}</td>
												<td>{{ $financial->job_number }}</td>
												<td class="text-right">{{ $financial->distribution_amount }}</td>

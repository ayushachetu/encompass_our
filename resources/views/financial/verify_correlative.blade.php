				...
				<div class="panel panel-piluku">
					<div class="panel-body">
						...
						<div class="pricing-header">
							Invoices  don't match with Coupa, please mark as exported=FALSE the following invoices on Coupa:
						</div>
						<table class="table table-bordered">
							@foreach ($list_invoices_numbers as $item)
								<tr><td><h4><strong>{{$item}}</strong></h4></td></tr>
							@endforeach
						</table>

	...
	<div class="content" id="content">
		...
		<div class="page_header">
			<div class="pull-left">
				...
				<span class="main-text">{{$name}} | Actual Vrs Target</span>
                            ...
                            <div class="col-md-12">
                                <table class="table table-bordered table-striped table-report" id="displayTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">${{number_format( $data_actual[$key]- $data_budget[$key],2)}}</td>
                                    </tr>
                                    <?php 
...
@section('scripts')
  ...
  <script type="text/javascript">
     ...
     $('#report-type').on('change', function (e) { 
            window.location.replace("/report/actual-budget/"+$(this).val());
     });

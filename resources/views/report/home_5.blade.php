	...
	<div class="content" id="content">
		...
		<div class="page_header">
			...
			<div class="pull-right">
				<a href="/report/ler-detail" class="btn btn-success btn-lg">Detail <span class="icon  ti-angle-double-right "></span></a>
			</div>
		...
		<div class="main-content">
			...
			<div class="row">
				<div class="col-md-6 col-xs-12 col-sm-6 ">
					...
					<div>
						<a class="btn btn-block btn-info" href="{{url('/')}}/report/ler-view/1" >View Details</a>
					</div>
				</div>
				<div class="col-md-6 col-xs-12 col-sm-6 ">
					<div id="graph-industry"></div>
					<div>
						<a class="btn btn-block btn-info" href="{{url('/')}}/report/ler-view/2" >View Details</a>
					</div>
				</div>
			</div>
			<br/>
			<div class="row">
				...
				<div class="col-md-6 col-xs-12 col-sm-6 ">
					...
					<div>
						<a class="btn btn-block btn-info" href="{{url('/')}}/report/ler-view/3" >View Details</a>
					</div>
				</div>
				<div class="col-md-6 col-xs-12 col-sm-6 ">
					<div id="graph-manager"></div>
					<div>
						<a class="btn btn-block btn-info" href="{{url('/')}}/report/ler-view/4" >View Details</a>
					</div>
				</div>
			</div>
			<!--row-->
  	...
  	$(function () {
	    $('#graph-county').highcharts({
	        ...
	        @foreach ($county_list as $key => $item)
	        	{
		            name: '{{$item}}',
		            data: [{{number_format($data_county_ler[$key],2, '.','')}}]
	    ...
	    $('#graph-industry').highcharts({
	        ...
	        @foreach ($industry_list as $key => $item)
	        	{
		            name: '{{$item}}',
		            data: [{{number_format($data_industry_ler[$key],2, '.','')}}]
	    ...
	    $('#graph-mayor').highcharts({
	        ...
	        @foreach ($mayor_list as $key => $item)
	        	{
		            name: '{{$item}}',
		            data: [{{number_format($data_mayor_ler[$key],2, '.','')}}]
		        },
	    	@endforeach
	        ]
	    });
	    $('#graph-manager').highcharts({
	        ...
	        @foreach ($manager_list as $key => $item)
	        	{
		            name: '{{$item}}',
		            data: [{{number_format($data_manager_ler[$key],2, '.','')}}]
		        },
	    	@endforeach
	        ]
	    });

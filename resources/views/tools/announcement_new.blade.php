			...
			<div class="col-md-12">
				...
				<div class="panel panel-piluku">
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-12">
								<h3><i class="icon ti-announcement"></i> Create Announcement</h3>	
							</div>
						</div>
						<hr/>
							...
							<div id="main-form">
	                            ...
	                            <div class="row">
		                            <div class="col-md-4 col-sm-12">
			                            ...
			                            <input type="text" name="closing_date" id="closing_date" class="form-control date-format" data-validation="required" value="{{ $date_insert }}">
			                        </div>
			                    </div>
	                            <div class="row">
		                            <div class="col-md-12 col-sm-12">
		                            	<h4>Title</h4>
			                            <input type="text" name="title" id="title" class="form-control" data-validation="required" value="{{ old('title') }}">
			                        </div>
			                    </div>
	                            <div class="row">
		                            <div class="col-md-12 col-sm-12">
		                            	<h4>Message</h4>
			                            <textarea name="message" class="form-control" style="height: 200px;line-height:120%;">{{ old('message') }}</textarea>
			                        </div>
			                    </div>
	                            <br/>
	                            <div class="row">

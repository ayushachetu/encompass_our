						...
						<div class="panel-body nopadding">
							<div class="table-responsive">
								<table class="table table-hover">
									...
									<tbody>
										@foreach ($pay as $pay_item)
											<tr class="table-row">
												<td>{{ $pay_item->employee_number }}</td>
												<td>{{ $pay_item->job_number }}</td>
												<td>{{ $pay_item->work_date }}</td>
												<td>{{ $pay_item->hours }}</td>
												<td>{{ $pay_item->lunch }}</td>
												<td>{{ $pay_item->pay_rate }}</td>
											</tr>
										@endforeach
									</tbody>
								</table>
